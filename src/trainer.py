...
from model.models import MedAlign

class MedAlignTrainer():
    def __init__(self, config, device, datasets, new_datasets,drug_text_embs):
        super(MedAlignTrainer, self).__init__()
    ...
    def get_model(self):
        model = MedAlign(self.voc_size, self.embed_dim, self.drug_smile_matrix, self.smile_subs_matrix, self.ddi_adj,
